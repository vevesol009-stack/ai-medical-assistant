"""
AI Medical Diagnosis Assistant - Simple Flask Demo
...
def diagnose():
    ...
    diagnosis = f"""
        <div class="space-y-4">
            <div>
                <strong class="text-green-900">Patient Profile:</strong>
                <p class="mt-1 text-gray-700">Age: {age} | Gender: {gender}</p>
            </div>
            <div>
                <strong class="text-green-900">Preliminary Assessment:</strong>
                <p class="mt-2">Based on the symptoms described ({symptoms[:80]}...), 
